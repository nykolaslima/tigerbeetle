...
pub fn build(b: *std.Build) !void {
    ...
    { // zig build client:$lang
        go_client(b, build_steps.clients_go, mode, vsr_options, tb_client_header_generate);
        ...
        c_client(b, build_steps.clients_c, mode, vsr_options, tb_client_header_generate);
    }
    ...
    { // zig build client:c:sample
        ...
        build_steps.clients_c_sample.dependOn(&tb_client_header_generate.step);
    }
}
...
fn go_client(
    ...
    tb_client_header_generate: *std.Build.Step.Run,
) void {
    ...
    install_header.step.dependOn(&tb_client_header_generate.step);
